...
namespace Q2.DataAccess
{
    public partial class PE_PRN211_23SprB1Context : DbContext
    {
        ...
        public virtual DbSet<ClassInfo> Classes { get; set; } = null!;
            ...
            modelBuilder.Entity<Student>(entity =>
            {
                ...
                entity.HasMany(d => d.Classes)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        "StudentClass",
                        l => l.HasOne<ClassInfo>().WithMany().HasForeignKey("Classid").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_Student_Class_Class"),
